...
def update_watchlist_items_fx(trello_id, oanda_id, psei_id, notifications_id,board: DtoBoard, list: DtoList, labels: [], **kwargs):
    ...
    oanda_price_service = ApiServicePricing(psei_id)
    ...
    for card in current_cards:
        ...
        try:
            price_info = QList(oanda_price_service.get_pricing(id,
                                                         short_name[:3] + '_' + short_name[3:])).first()
        except:
            price_info = None
